                                ...
                                <div class="table-responsive">
                                    ...
                                    <th>Status</th>
                                        ...
                                        <tbody>
                                            <tr>
                                               <?php
$sql="SELECT tbllodgedcomplain.ComplainNumber,tbllodgedcomplain.AssignTo,tbllodgedcomplain.ID as compid,tbllodgedcomplain.Status,tbluser.ID as uid,tbluser.FullName,tbluser.MobileNumber,tbluser.Email from tbllodgedcomplain join tbluser on tbluser.ID=tbllodgedcomplain.UserID where date(tbllodgedcomplain.ComplainDate) between '$fdate' and '$tdate'";
